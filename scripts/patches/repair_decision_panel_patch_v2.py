...
def main() -> None:
    ...
    if "repair-decision-panel-v2" in source:
        print("Repair Decision Panel v2 patch already applied.")
        return

    helper_block = """      // repair-decision-panel-v2
...
"""
    ...
    ui_block = """      {/* repair-decision-panel-v2 */}
...
"""
    ...
    backup = PAGE.with_name(PAGE.name + ".repair-decision-panel-v2.bak")
