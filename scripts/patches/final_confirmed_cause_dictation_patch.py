...
def main() -> None:
    ...
    if "final-confirmed-cause-dictation-v1" in source:
        print("Final Confirmed Cause dictation patch already applied.")
        return

    helper_block = """      // final-confirmed-cause-dictation-v1
...
"""
    source = insert_after_value_field(
        ...
        ui_block,
        "final confirmed cause dictation UI",
    )

    backup = PAGE.with_name(PAGE.name + ".final-confirmed-cause-dictation.bak")
