...
def main() -> None:
    ...
    if "guided-next-test-engine-v2" in source:
        print("Guided Next-Test Engine patch already applied.")
        return

    if "buildGuidedNextTests" not in source:
        helper_block = """      // guided-next-test-engine-v2
...
"""
    ...
    ui_block = """      {/* guided-next-test-engine-v2 */}
...
"""
    ...
    backup = PAGE.with_name(PAGE.name + ".guided-next-test-engine-v2.bak")
