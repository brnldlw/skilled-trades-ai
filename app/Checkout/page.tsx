      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "calc(100vh - 52px)", padding: 24, textAlign: "center" }}>
        ...
        {status === "error" && (
          <>
            ...
            <div style={{ fontSize: 14, color: "#94a3b8", marginBottom: 24, maxWidth: 400 }}>
              {error}
            </div>
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" as const, justifyContent: "center" }}>
              <a href="/pricing" style={{ padding: "11px 24px", background: "#f97316", color: "#fff", borderRadius: 8, fontWeight: 700, fontSize: 14 }}>
                Back to Pricing
              </a>
              <a href="mailto:support@myhvacrtool.com" style={{ padding: "11px 24px", background: "rgba(255,255,255,0.08)", color: "#94a3b8", borderRadius: 8, fontWeight: 700, fontSize: 14 }}>
                Contact Support
              </a>
            </div>
          </>
